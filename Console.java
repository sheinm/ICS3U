...
public static void println (String)
{
	...
	public interface Console {String[] continents = { "Africa", "South America", "Australia", "Antartica" };
	// array that chooses the continent the user will go to 


	public static void main(String[] args, BufferedImage antartica, BufferedImage australia) throws InterruptedException
	{  


		Console interact = new console (500,500);
		...
		do {
			...
			noriegaKrisnarajah console;

			BufferedImage huntingParty = null;
			try{
				huntingParty = ImageIO.read(new File("PictureResources/gamecover.jpg"));
			}
			catch (IOException e){
			...
			userChoice = interact.readLine();// User has no choice but to accept the offer
		...
		public void setTextBackgroundColor(Color black);



		public void setTextColor(Color blue);
		...
		public static String getRandomContinent() {
			AdventureGame m = new AdventureGame();

			int randomContinent = new Random().nextInt(m.continents.length);
			return "Africa";
